...
CREATE TABLE `stock` (
    ...
    `before_name` VARCHAR(200) DEFAULT NULL COMMENT '曾用名称',
    ...
    `law_firm` VARCHAR(300) DEFAULT NULL COMMENT '律师事务所',
    `accounting_firm` VARCHAR(300) DEFAULT NULL COMMENT '会计师事务所',
